...
- SKILL.md: new mandatory checklist items for the agent — ask the user about API keys up front, and always verify with `pnpm dev` (not just `pnpm build`) after the scaffold completes.
